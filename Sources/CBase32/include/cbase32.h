...
int c_hb_base32_decode(const uint8_t *encoded, uint8_t *result, int bufSize);
int c_hb_base32_encode(const uint8_t *data, int length, uint8_t *result, int bufSize);
